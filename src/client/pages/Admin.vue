...
<template>
	...
	<Layout v-if="user && user.role === 'admin'">
		...
		<nav class="pagination" aria-label="Pagination">
			...
			<span v-else class="btn btn-ghost" aria-disabled="true">Previous</span>
			<span class="pagination-page">Page {{ currentPage }} of {{ lastPage }}</span>
			<Link
			...
			<span v-else class="btn btn-ghost" aria-disabled="true">Next</span>
		</nav>
	</Layout>
</template>
