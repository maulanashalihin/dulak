...
export default function Profile() {
  ...
  return (
    <Layout>
      <Head title="Profile" />
      <h1>Profile</h1>
      <p className="page-sub">Manage your account — avatar, profile information and password.</p>
        ...
        <aside className="profile-aside">
          <section className="panel profile-card">
            ...
            <div className="profile-meta">
              ...
              <span className="profile-since">Member since {formatDate(user.createdAt)}</span>
            </div>
            ...
            <div className="profile-upload">
              ...
              >
                {phase === 'uploading' ? 'Uploading…' : pending ? 'Resume upload' : 'Change avatar'}
              </button>
              {pending ? (
        ...
        <div className="profile-forms">
          <section className="panel">
            ...
            <form onSubmit={submitInfo} noValidate>
              ...
              <button className="btn btn-primary" type="submit" disabled={info.processing}>
          ...
          <section className="panel">
            ...
            <form onSubmit={submitPass} noValidate>
              ...
              <button className="btn btn-primary" type="submit" disabled={pass.processing}>
