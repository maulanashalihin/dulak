...
description: "SQLite with WAL mode serves 526K reads/s and 95K writes/s direct — 52K reads/s even through the full HTTP stack. Adding Redis would be a dependency that solves a problem Dulak doesn't have."
date: 2026-08-08
authors:
  - maulana
tags:
