...
The numbers: [52K reads/s, 95K writes/s](/database/performance/) on a laptop. The backup: copy a file. The swap: architectural, not performance — and scheduled, not emergency. The cost: zero infrastructure until you need it.
