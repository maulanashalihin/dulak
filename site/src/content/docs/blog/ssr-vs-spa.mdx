---
title: "SSR vs SPA: 50ms to content, or 2 seconds of blank screen"
description: "SSR ships HTML on the first byte — 50ms to content. SPA ships an empty div and a JS bundle — 500ms to 2s on a budget phone. SSR is crawlable, mobile-friendly, and has no hydration waterfall. Dulak does it in-process, no separate server."
date: 2026-08-08
authors:
  - maulana
tags:
