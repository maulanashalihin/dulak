---
title: "Tailwind is a build step you don't need"
description: "Tailwind is powerful, but it adds a build step and a mental model. Vanilla CSS in 2026 has native nesting, custom properties, grid, and flexbox. The problems Tailwind solved are mostly gone — so Dulak ships vanilla CSS by default."
date: 2026-08-08
authors:
  - maulana
tags:
